...
cl /nologo /std:c++latest /D_CONTAINER_DEBUG_LEVEL=1 /EHsc /W4 /WX /diagnostics:caret /diagnostics:color /Z7 %timing_flag% fredbuf-test.cpp /Fefredbuf-test.exe %spall_flag%
